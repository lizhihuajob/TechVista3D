<template>
  <div class="threejs-category-page">
    <div class="page-header">
      <div class="container">
        <div class="breadcrumb">
          <router-link to="/">首页</router-link>
          <span class="separator">/</span>
          <span class="current">Three.js案例</span>
        ...
        <div class="page-intro">
          ...
          <div class="intro-content">
            <h1 class="page-title">Three.js 案例库</h1>
      ...
      <div class="page-content">
        ...
        <main class="main-content">
          ...
          <div class="category-info" v-else>
            ...
            <p class="category-desc">浏览所有Three.js案例，按分类筛选查看</p>
...
const getCategoryIdByItem = (item) => {
  ...
  return categories.value[0]?.id || 'basic-scene'
}
