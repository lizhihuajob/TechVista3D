<template>
    ...
    <div class="page-header">
      <div class="container">
        <div class="breadcrumb">
          ...
          <router-link to="/cesium">Cesium案例</router-link>
          <span class="separator">/</span>
          <router-link :to="`/cesium/${category.id}`">{{ category.name }}</router-link>
          <span class="separator">/</span>
        ...
        <div class="case-body">
          ...
          <div class="section" v-if="relatedCases.length > 0">
            ...
            <div class="related-cases">
              ...
              >
                <router-link 
                  :to="`/cesium/${category.id}/${related.id}`"
                  class="related-link"
                >
          ...
          <div class="navigation-section">
            <router-link 
              v-if="hasPrev" 
              :to="`/cesium/${category.id}/${prevCase.id}`"
              class="nav-btn prev"
            >
            ...
            <router-link 
              v-if="hasNext" 
              :to="`/cesium/${category.id}/${nextCase.id}`"
              class="nav-btn next"
            >
              <div class="nav-text">
  ...
  <div class="not-found" v-else>
    ...
    <router-link to="/cesium" class="btn btn-primary">返回案例列表</router-link>
  </div>
</template>
...
import { getCesiumComponent } from '@/components/cases'
...
const loadCaseComponent = async (caseId) => {
  ...
  const componentLoader = getCesiumComponent(caseId)
  if (componentLoader) {
    try {
